...
Module.register("MMM-MLB", {
    ...
    getDom: function() {
        ...
        if (this.standings === false) {
            ...
            //here you do the standing generation
            for (var i = 0; i < this.standings.length; i++) {
                ...
                header.innerHTML = "MLB Standings " + moment().format('MM/DD/YYYY');
                wrapper.appendChild(header);

                var large = document.createElement("div");
                large.classList = "small bright";
                ...
                firstrow.appendChild(teamcolumn);
                standingsTable.appendChild(firstrow);

                var teamswinColumn = document.createElement("th");
                teamswinColumn.setAttribute("colspan", 1);
                teamswinColumn.classList.add("r");
                teamswinColumn.innerHTML = "W";
                firstrow.appendChild(teamswinColumn);
                standingsTable.appendChild(firstrow);

                var lossColumn = document.createElement("th");
                lossColumn.setAttribute("colspan", 1);
                lossColumn.classList.add("h");
                lossColumn.innerHTML = "L";
                firstrow.appendChild(lossColumn);
                standingsTable.appendChild(firstrow);

                var notColumn = document.createElement("th");
                notColumn.setAttribute("colspan", 1);
                notColumn.classList.add("e");
                notColumn.innerHTML = "NOT";
                firstrow.appendChild(notColumn);
                standingsTable.appendChild(firstrow);

                var happyColumn = document.createElement("th");
                happyColumn.setAttribute("colspan", 1);
                happyColumn.className = "small bright";
                happyColumn.innerHTML = "HAPPY";
                firstrow.appendChild(happyColumn);
                standingsTable.appendChild(firstrow);


                var teamsShowTemp = document.createElement("tr");
                var teamsShowColumn = document.createElement("td");
                teamsShowColumn.setAttribute("colspan", 1);
                teamsShowColumn.innerHTML = standings.team_id + " " + standings.rank;
                teamsShowTemp.appendChild(teamsShowColumn);
                standingsTable.appendChild(teamsShowTemp);

                large.appendChild(standingsTable);
                wrapper.appendChild(large);


                if (this.standings[i].division === "E") {
                    console.log("Rank: " + this.standings[i].rank);
                    console.log("Team: " + this.standings[i].team_id);
                    console.log("Won: " + this.standings[i].won);
                    console.log("Lost: " + this.standings[i].lost);
                }
            }
        }
    ...
    // it cant be the update as this is set to every 2 mins
